package com.dianaq.myapp.settings
...
import com.dianaq.myapp.databinding.ActivitySettingsBinding
...
val Context.dataStore: DataStore<Preferences> by preferencesDataStore(name = "settings") //name es el nombre que le coloquemos a la base de datos
